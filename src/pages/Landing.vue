  ...
  <div class="layout">
    ...
    <main class="layout-main">
      ...
      <section class="hero">
        ...
        <!-- Decorative circles -->
        <img :src="circleOne" alt="" class="circle circle-one" aria-hidden="true" />
        <img :src="circleTwo" alt="" class="circle circle-two" aria-hidden="true" />

        <div class="container hero-content">
          <div class="content-left">
            <span>Customer Support Platform</span>
            <h1 class="hero-title">Customer support, elevated.</h1>
            <p class="hero-text">
          ...
          <Card class="content-right">
            <h3 style="margin-top: 0;">Designed for modern teams</h3>
            <ul
              style="margin: 1.25rem 0 0; padding-left: 1.25rem; color: var(--text-muted); line-height: 1.6;"
            >
      ...
      <section class="features">
        <div class="container">
          <div class="features-header">
            ...
            <p>
              From the first response to final resolution, TicketApp Vue keeps service teams aligned.
